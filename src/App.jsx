...
function shell(extra = {}) {
  return {
    ...
    borderRadius: 22,
    boxShadow:
      "0 28px 90px rgba(0,0,0,0.20), inset 0 1px 0 rgba(255,255,255,0.04)",
...
function clampWindowToViewport(win) {
  ...
  const x = Math.min(Math.max(win.x, margin), viewportWidth - width - margin);
  const y = Math.min(Math.max(win.y, margin), viewportHeight - height - margin);
      ...
      {dots.map((d) => (
        <motion.div
          ...
          style={{
            ...
            boxShadow:
              "0 0 14px rgba(255,216,128,0.72), 0 0 30px rgba(255,216,128,0.18)",
            filter: "blur(0.15px)",
          }}
          animate={{
    ...
    <>
      <motion.div
        style={{
          ...
          borderRadius: 60,
          background:
            "radial-gradient(circle, rgba(108,138,255,0.16), rgba(108,138,255,0.06) 38%, transparent 68%)",
          filter: "blur(26px)",
          pointerEvents: "none",
        }}
      ...
      <motion.div
        style={{
          ...
          height: 210,
          background:
            "radial-gradient(ellipse at center, rgba(255,201,106,0.16), rgba(255,201,106,0.05) 40%, transparent 74%)",
          filter: "blur(20px)",
          pointerEvents: "none",
        }}
      ...
      <motion.div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(90,134,255,0.12), transparent 72%)",
          filter: "blur(34px)",
          pointerEvents: "none",
        }}
      ...
      <motion.div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(255,184,92,0.14), transparent 72%)",
          filter: "blur(30px)",
          pointerEvents: "none",
        }}
  ...
  return (
    <motion.div
      style={{
        ...
        borderRadius: 3,
        background:
          "linear-gradient(180deg, rgba(255,214,150,0.32), rgba(255,169,92,0.18))",
  ...
  return (
    <span
      style={{
        ...
        height: 16,
        borderRadius: 10,
        background: `radial-gradient(circle at 30% 30%, ${color}, rgba(34,68,34,0.96))`,
        ...
        >
          <div
            style={{
              ...
              background:
                "linear-gradient(180deg, rgba(9,13,24,0.16), rgba(9,13,24,0.03))",
            }}
          />
          <div
            style={{
        ...
        {[
          ...
          <motion.button
            ...
            style={{
              ...
              border:
                i === 1
                  ? "1px solid rgba(255,214,140,0.28)"
                  : "1px solid rgba(182,204,255,0.11)",
              background:
                i === 1
                  ? "linear-gradient(180deg, rgba(92,101,188,0.84), rgba(28,34,75,0.94))"
                  : "linear-gradient(180deg, rgba(22,28,56,0.84), rgba(8,11,24,0.96))",
              color: "#eef2ff",
              display: "flex",
    ...
    >
      <div
        ...
        style={{
          ...
          cursor: "grab",
          background:
            "linear-gradient(180deg, rgba(18,24,50,0.92), rgba(9,12,24,0.92))",
        }}
      >
        <div style={{ ...titleCaps(13), letterSpacing: 2.4 }}>{win.title}</div>
        <div style={{ display: "flex", gap: 8 }}>
          <button onClick={() => onMinimize(win.id)} style={miniButtonStyle()}>
            <Minus size={15} />
          </button>
          <button style={miniButtonStyle()}>
            <Maximize2 size={14} />
          </button>
          <button onClick={() => onClose(win.id)} style={miniButtonStyle()}>
            <X size={15} />
          </button>
        </div>
      </div>
        ...
        <>
          ...
          <div
            ...
            style={{
              ...
              cursor: "nwse-resize",
              background:
                "linear-gradient(135deg, transparent 45%, rgba(255,255,255,0.28) 45%, rgba(255,255,255,0.28) 55%, transparent 55%)",
              opacity: 0.8,
            }}
          />
        </>
  ...
  return (
    ...
    >
      <div style={{ ...shell({ padding: 20, width: "100%", maxWidth: 520 }) }}>
        ...
        >
          Tu as cliqué sur le plan. On enregistre d’abord la case ici, puis on la
          branchera exactement où il faut.
        </div>
        ...
        <form onSubmit={submit}>
          ...
          >
            ...
            <select
              value={form.exposure}
              onChange={(e) =>
                setForm((f) => ({ ...f, exposure: e.target.value }))
              }
              style={fieldStyle()}
            >
              {["Mi-ombre", "Bonne lumière", "Chaud / protégé"].map((o) => (
                <option
                  key={o}
                  value={o}
                  style={{ background: "#0b1022", color: "#eef2ff" }}
                >
                  {o}
                </option>
              ))}
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", gap: 10, marginTop: 18 }}>
            ...
            <button
              ...
              style={{
                ...
                background:
                  "linear-gradient(180deg, rgba(86,100,190,0.90), rgba(35,42,95,0.95))",
                color: "#fff8ef",
                fontWeight: 800,
                fontSize: 15,
                cursor: "pointer",
...
function renderWindowContent(mode, cases) {
  const texts = {
    ...
    suggestion:
      "Déplacer 3 pots vers la zone Est et garder la zone chaude pour les piments.",
    today:
      "Tailler les fraises, surveiller l’humidité du matin et vérifier la lumière des semis prioritaires.",
      ...
      <div style={{ display: "grid", gap: 14, height: "100%" }}>
        <div
          style={soft({
            padding: 16,
            background:
              "linear-gradient(180deg, rgba(10,16,38,0.26), rgba(6,10,24,0.38))",
          })}
        >
          <div style={{ ...titleCaps(14), marginBottom: 8 }}>Plan isolé du potager</div>
          <div style={{ color: "rgba(232,238,255,0.72)", lineHeight: 1.6 }}>
            Cette fenêtre doit devenir l’espace dédié au plan, indépendant de
            l’accueil, pour travailler les cases, les pots et la disposition
            générale.
          </div>
        </div>
        ...
        <div
          style={{
            ...
            border: "1px solid rgba(182,204,255,0.12)",
            background:
              "linear-gradient(180deg, rgba(10,16,34,0.22), rgba(6,10,22,0.34))",
        ...
        >
          <div
            style={{
              ...
              inset: 18,
              borderRadius: 18,
              border: "1px solid rgba(181,202,255,0.14)",
              background:
                "linear-gradient(180deg, rgba(8,12,24,0.14), rgba(8,12,24,0.04))",
            }}
          />
          <div
            style={{
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap", justifyContent: "flex-end" }}>
                {["20 cm", "30 cm", "40 cm"].map((d) => (
                  <span
                    key={d}
                    style={{
                      ...soft({ padding: "6px 8px", borderRadius: 10 }),
                      fontWeight: 800,
                      fontSize: 12,
                    }}
                  >
  ...
  return (
    <div style={{ display: "grid", gap: 14 }}>
      <div style={soft({ padding: 18 })}>
        <div style={{ color: "#eef2ff", lineHeight: 1.72 }}>
          {texts[mode] || texts.status}
        </div>
      </div>
        ...
        <div style={{ display: "grid", gap: 8 }}>
          {cases.map((c) => (
            ...
            >
              ...
              <span style={{ color: "rgba(214,222,255,0.62)", fontSize: 13 }}>
                {c.crop} · {c.zone}
              </span>
            </div>
          ))}
...
export default function App() {
  ...
  const [homeWindow, setHomeWindow] = useState(() =>
    typeof window !== "undefined"
      ? clampWindowToViewport(createWindow("home", 0))
      : createWindow("home", 0)
  );
  ...
  useEffect(() => {
    function syncWindowsToViewport() {
      setHomeWindow((current) => clampWindowToViewport(current));
      setWindows((current) => current.map((w) => clampWindowToViewport(w)));
    }
  ...
  function openWindow(mode) {
    setWindows((current) => {
      const created = clampWindowToViewport(createWindow(mode, current.length + 1));
  ...
  function reopenHomeWindow() {
    setHomeWindow((current) =>
      clampWindowToViewport({ ...current, closed: false, minimized: false })
    );
  ...
  function moveHomeWindow(_, pos) {
    setHomeWindow((current) => clampWindowToViewport({ ...current, ...pos }));
  }

  function resizeHomeWindow(_, size) {
    setHomeWindow((current) => clampWindowToViewport({ ...current, ...size }));
  }
  ...
  function moveWindow(id, pos) {
    setWindows((current) =>
      current.map((w) =>
        w.id === id ? clampWindowToViewport({ ...w, ...pos }) : w
      )
    );
  }
  ...
  function resizeWindow(id, size) {
    setWindows((current) =>
      current.map((w) =>
        w.id === id ? clampWindowToViewport({ ...w, ...size }) : w
      )
    );
  }
    ...
    >
      ...
      <div
        style={{
          position: "absolute",
          inset: 0,
          background: "linear-gradient(180deg, rgba(4,8,18,0.02), rgba(4,8,18,0.14))",
        }}
      />
      <div
        style={{
      ...
      {homeWindow.closed ? (
        <button
          ...
          style={{
            ...
            background:
              "linear-gradient(180deg, rgba(13,20,46,0.88), rgba(6,10,24,0.94))",
            color: "#eef2ff",
            fontWeight: 800,
            letterSpacing: 1.1,
            cursor: "pointer",
