...
function shell(extra = {}) {
  return {
    background:
      "linear-gradient(180deg, rgba(8,14,34,0.70), rgba(5,9,22,0.84))",
    border: "1px solid rgba(182,204,255,0.13)",
    borderRadius: 22,
    boxShadow:
      "0 22px 80px rgba(0,0,0,0.34), inset 0 1px 0 rgba(255,255,255,0.05)",
...
function soft(extra = {}) {
  return shell({
    background:
      "linear-gradient(180deg, rgba(12,18,40,0.78), rgba(7,10,22,0.90))",
    borderRadius: 16,
    ...extra,
  });
}
...
function fieldStyle() {
  return {
    ...
    background:
      "linear-gradient(180deg, rgba(23,30,64,0.74), rgba(9,12,25,0.92))",
    color: "#eef2ff",
    outline: "none",
    padding: "0 14px",
    fontSize: 14,
  ...
  return (
    <div
      style={shell({
        padding: 18,
        boxShadow:
          "0 32px 90px rgba(0,0,0,0.42), 0 0 60px rgba(90,120,255,0.06), inset 0 1px 0 rgba(255,255,255,0.06)",
      })}
    >
      <div
        style={{
      ...
      >
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(180deg, rgba(14,20,44,0.18), rgba(7,10,20,0.30))",
        ...
        <div style={shell({ padding: 14, width: 246 })}>
          ...
          <div style={{ display: "grid", gap: 8 }}>
            ...
            <div style={soft({ padding: 12 })}>
              ...
              >
                <div style={{ color: "#f1f4ff", fontSize: 15, fontWeight: 800 }}>
                  Laitue
                </div>
      ...
      >
        ...
        >
          ...
          <div style={{ marginTop: 14, color: "#eef2ff", fontSize: 15, lineHeight: 1.62 }}>
...
function FloatingWindow({
  ...
  return (
    ...
    >
      ...
      {!win.minimized ? (
        <>
          <div style={{ height: "calc(100% - 54px)", overflow: "auto", padding: 14 }}>
            {children}
          </div>
          <div
        ...
        <form onSubmit={submit}>
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", gap: 10, marginTop: 18 }}>
            <button
              type="button"
              onClick={onClose}
              style={{ ...fieldStyle(), width: 120, cursor: "pointer", fontWeight: 700 }}
            >
              Annuler
            </button>
            <button
    ...
    >
      ...
      <div
        style={{
          position: "absolute",
          inset: 0,
          background: "radial-gradient(circle at center, rgba(255,255,255,0.035), transparent 46%)",
        }}
      />
      <AmbientGlow />
      <HouseLights />
